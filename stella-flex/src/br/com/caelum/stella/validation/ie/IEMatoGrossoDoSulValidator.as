package br.com.caelum.stella.validation.ie
{
	...
	public class IEMatoGrossoDoSulValidator extends AbstractIEValidator {
		...
		*/		
		public static const FORMATTED:RegExp = /^(28)[.](\d{3})[.](\d{3})[-](\d{1})$/;
		public static const UNFORMATTED:RegExp = /^(28)(\d{3})(\d{3})(\d{1})$/;
		
		public function IEMatoGrossoDoSulValidator(isFormatted:Boolean = true, messageProducer:MessageProducer = null) {
