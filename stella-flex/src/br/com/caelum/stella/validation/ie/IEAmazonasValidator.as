package br.com.caelum.stella.validation.ie
{
	...
	public class IEAmazonasValidator extends AbstractIEValidator {
		...
		public static const UNFORMATTED:RegExp = /^(\d{2})(\d{3})(\d{3})(\d{1})$/;
		
		public function IEAmazonasValidator(isFormatted:Boolean = true, messageProducer:MessageProducer = null) {
