 ...
 */
public class StellaIESPValidator implements javax.faces.validator.Validator,
		javax.faces.component.StateHolder {
	/**
	 * Identificador do Validador JSF.
	 */
	public static final String VALIDATOR_ID = "StellaIESPValidator";
	...
	public void validate(FacesContext facesContext, UIComponent uiComponent,
		...
		InscricaoEstatudalDeSaoPauloValidator validator = new InscricaoEstatudalDeSaoPauloValidator(producer, formatted);
