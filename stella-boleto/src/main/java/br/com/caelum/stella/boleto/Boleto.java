...
public class Boleto implements Serializable {
      ...
      * 
      */
     private static final long serialVersionUID = -4371084679352769986L;
     ...
     public static Boleto novoBoleto() {
          return new Boleto().comEspecieMoeda("R$")
               .comCodigoEspecieMoeda(9).comRegistrado(true)
    ...
    public Boleto comDescricao(String descricao) {
     ...
     public String getFatorVencimento() {
          ...
          return (registrado ? String.valueOf((int) diferencasEmDias) : "0000");
     }
     ...
     public String getValorFormatado() {
          return String.format("%011.2f", (registrado ? this.getValorBoleto() : 0.)).replaceAll("[^0-9]", "");
     }
     ...
     /**
      * @return boleto registrado que por default sempre é false
      */
     ...
     /**
      * @param boleto registrado
      * @return este boleto
      */
     public Boleto comRegistrado(boolean registrado) {
