 ...
 * 
 */
public class BoletoHTMLServlet extends HttpServlet {
	...
	private BufferedImage getCorrectImageFor(
			String tipoRecurso, String value) throws IOException {
		BufferedImage image;
		if ("img".equals(tipoRecurso)) {			
			image = BufferedImageGenerator
					.generateBufferedImageFor(
							ImageIO
									.read(BoletoHTMLServlet.class
											.getResource("/br/com/caelum/stella/boleto/img/"
													+ value)),
							BufferedImage.TYPE_INT_ARGB);
		} else {			
			//ainda tem que ajeitar a altura e talvez o tamanho da imagem gerada. Pode receber como parametro tb...
