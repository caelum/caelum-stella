...
public class HSBC extends AbstractBanco implements Banco {
     ...
     public String geraCodigoDeBarrasPara(Boleto boleto) {
          ...
          campoLivre.append(boleto.getRegistrado() ? getDataFormatoJuliano(boleto.getDatas().getVencimento(), 4) : "0000");
     ...
     private DigitoPara getModuloNossoNumero(String nossoNumero) {
          ...
          return new DigitoPara(nossoNumero).trocandoPorSeEncontrar("0", 10, 11).comMultiplicadores(9, 8, 7, 6, 5, 4, 3, 2).mod(11);
     }
