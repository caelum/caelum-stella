...
public class BancoDoBrasilTest {
    ...
    public void setUp() {
        ...
        boleto = Boleto.newBoleto().withDatas(datas).withEmissor(emissor).withSacado(sacado).withValorBoleto("40.00")
    ...
    public void numeroDoConvenioFormatadoDeveTerSeisDigitos() {
        ...
        String numeroFormatado = banco.getNumConvenioDoEmissorFormatado(emissor);
    ...
    public void testNumeroFormatadoNoCodigoDeBarraDoBancoDoBrasil() {
        ...
        assertEquals("001", banco.geraCodigoDeBarrasPara(boleto).substring(0, 3));
    }
    ...
    public void testFatorVencimentoNoCodigoDeBarraDoBancoDoBrasil() {
        ...
        assertEquals("3860", banco.geraCodigoDeBarrasPara(boleto).substring(5, 9));
    }
    ...
    public void testValorNominalNoCodigoDeBarraDoBancoDoBrasil() {
        ...
        assertEquals("0000004000", banco.geraCodigoDeBarrasPara(boleto).substring(9, 19));
    }
    ...
    public void testCampoLivreNoCodigoDeBarraDoBancoDoBrasil() {
        ...
        assertEquals("0000001207113000900020618", banco.geraCodigoDeBarrasPara(boleto).substring(19, 44));
    }
    ...
    public void testZerosNoCampoLivreNoCodigoDeBarraDoBancoDoBrasil() {
        ...
        assertEquals("000000", banco.geraCodigoDeBarrasPara(boleto).substring(19, 25));
    }
    ...
    public void testNumConvenioFormatadoNoCampoLivreNoCodigoDeBarraDoBancoDoBrasil() {
        ...
        assertEquals("1207113", banco.geraCodigoDeBarrasPara(boleto).substring(25, 32));
    }
    ...
    public void testNossoNumeroFormatadoNoCampoLivreNoCodigoDeBarraDoBancoDoBrasil() {
        ...
        assertEquals("0009000206", banco.geraCodigoDeBarrasPara(boleto).substring(32, 42));
    }
    ...
    public void testCarteiraNoCampoLivreNoCodigoDeBarraDoBancoDoBrasil() {
        ...
        assertEquals("18", banco.geraCodigoDeBarrasPara(boleto).substring(42, 44));
    }
    ...
    public void testCodigoDeBarraDoBancoDoBrasil() {
        ...
        assertEquals("00195386000000040000000001207113000900020618", banco.geraCodigoDeBarrasPara(boleto));
    }
    ...
    public void testLinhaDoBancoDoBrasil() {
        ...
        assertEquals("00190.00009  01207.113000  09000.206186  5  38600000004000", banco.geraLinhaDigitavelPara(boleto));
    }
