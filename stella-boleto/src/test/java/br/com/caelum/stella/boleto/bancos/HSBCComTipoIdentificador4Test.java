...
public class HSBCComTipoIdentificador4Test {
    ...
    public void setUp() {
        ...
        Datas datas = Datas.newDatas().withDocumento(3, 7, 2000)
                .withVencimento(4, 7, 2000);
    ...
    public void testCodigoDoDocumentoFinalComDigitosVerificadores() {
        ...
        assertEquals(
                "39104766340",
                ((HSBC) this.banco).getCodigoDoDocumentoFinalComDigitosVerificadores(boleto));
    }
    ...
    public void testDataJuliana() {
        ...
        Assert.assertEquals("1860", hsbc.getDataFormatoJuliano(boleto
                .getDatas().getVencimento(), 4));
    }
