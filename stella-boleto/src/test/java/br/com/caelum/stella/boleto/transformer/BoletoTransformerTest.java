...
public class BoletoTransformerTest {
	...
	public void setUp() {
		...
		emissor = Emissor.newEmissor().withCedente("Caue").withAgencia(1824).withDigitoAgencia('4')
		...
		sacado = Sacado.newSacado().withNome("Fulano da Silva").withCpf("111.222.333-12")
	...
	public void testMinimumDateForDocumento() {
		banco = new BancoDoBrasil();
		Datas datas = Datas.newDatas().withDocumento(31, 12, 1979).withProcessamento(4, 5, 2008)
				.withVencimento(25, 8, 2008);
		boleto.withDatas(datas);
		boleto = boleto.withBanco(banco);
		transforma();
	}
	...
	public void testMinimumDateForProcessamento() {
		banco = new BancoDoBrasil();
		Datas datas = Datas.newDatas().withDocumento(4, 5, 2008).withProcessamento(31, 12, 1979)
				.withVencimento(25, 8, 2008);
		boleto.withDatas(datas);
		boleto = boleto.withBanco(banco);
		transforma();
