...
public class BradescoTest {
    ...
    public void testLinhaDoBancoBradesco() {
        ...
        assertEquals("23792.94909  60000.000004  03000.658009  6  31680000000100", banco.geraLinhaDigitavelPara(boleto));
    }
    ...
    public void testCodigoDeBarraDoBancoBradesco() {
        ...
        assertEquals("23796316800000001002949060000000000300065800", banco.geraCodigoDeBarrasPara(boleto));
    }
