...
public class COFINSInterfaceTest {
    ...
    public void testCOFINSTributadoPelaAliquota() {
        COFINS target = new COFINSBuilder()
                                           .cofinsAliquotaDiferenciada()
                                           .withAliquotaEmPercentual(new BigDecimal(1))
                                           .withValor(new BigDecimal(1))
                                           .withValorDaBaseDeCalculo(new BigDecimal(1));
        BuilderTestHelper.assertModelWasFilled(target);
    }
    ...
    public void testCOFINSSubstituicaoTributaria() {
        COFINS target = new COFINSBuilder()
                                           .cofinsSubstituicaoTributaria()
                                           .withAliquotaEmPercentual(new BigDecimal(1))
                                           .withAliquotaEmReais(new BigDecimal(1))
                                           .withQuantidadeVendida(1)
                                           .withValor(new BigDecimal(1))
                                           .withValorDaBaseDeCalculo(new BigDecimal(1));
        BuilderTestHelper.assertModelWasFilled(target);
    }
