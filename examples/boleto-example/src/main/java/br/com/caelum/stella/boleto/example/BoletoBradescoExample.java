...
public class BoletoBradescoExample {
	public static void main(String[] args) {
		...
		Emissor emissor = Emissor.newEmissor().withCedente("Fulano de Tal")
                ...
                .withNumConvenio("1234567").withDvContaCorrete("1").withCarteira("22")
                .withNossoNumero("0009050987");

		Sacado sacado = Sacado.newSacado().withNome("Fulano da Silva")
                .withCpf("111.222.333-12").withEndereco("Av dos testes, 111 apto 333")
				.withBairro("Bairro Teste").withCep("01234-111").withCidade("São Paulo")
                .withUf("SP");
