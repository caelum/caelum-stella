...
public class InscricaoEstatudalDeSergipeValidatorTest {
	...
	public void shouldNotValidateIEWithInvalidCharacter() {
		...
		Validator validator = new InscricaoEstatudalDeSergipeValidator(messageProducer,false);
		try {
	...
	public void shouldValidateValidFormattedIE(){
		...
		Validator validator = new InscricaoEstatudalDeSergipeValidator(messageProducer,true);
		List<ValidationMessage> errors;
