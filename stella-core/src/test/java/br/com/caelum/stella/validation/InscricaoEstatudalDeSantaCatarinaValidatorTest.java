...
public class InscricaoEstatudalDeSantaCatarinaValidatorTest {
	...
	public void shouldNotValidateIEWithInvalidCharacter() {
		...
		Validator validator = new InscricaoEstatudalDeSantaCatarinaValidator(messageProducer,false);
		try {
	...
	public void shouldValidateValidFormattedIE(){
		...
		Validator validator = new InscricaoEstatudalDeSantaCatarinaValidator(messageProducer,true);
		List<ValidationMessage> errors;
