...
public class InscricaoEstatudalDeMinasGeraisValidatorTest {
	...
	public void shouldNotValidateIEWithInvalidCharacter() {
		...
		Validator validator = new InscricaoEstatudalDeMinasGeraisValidator(messageProducer,false);
		try {
	...
	public void shouldValidateValidFormattedIE(){
		...
		Validator validator = new InscricaoEstatudalDeMinasGeraisValidator(messageProducer,true);
		List<ValidationMessage> errors;
