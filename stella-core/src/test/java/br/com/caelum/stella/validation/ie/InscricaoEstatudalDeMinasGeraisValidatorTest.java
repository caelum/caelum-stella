...
import br.com.caelum.stella.validation.ie.InscricaoEstatudalDeMinasGeraisValidator;
import br.com.caelum.stella.validation.Validator;
import br.com.caelum.stella.validation.InvalidStateException;

public class InscricaoEstatudalDeMinasGeraisValidatorTest {

    private final String validString = "062.307.904/0081";
    private final String wrongCheckDigitString = "062.307.904/0045";
    
    private Validator<String> newValidator(){
        return new InscricaoEstatudalDeMinasGeraisValidator();
    }
    ...
    public void shouldNotValidateIEWithInvalidCharacter() {
        ...
        Validator validator = new InscricaoEstatudalDeMinasGeraisValidator(
