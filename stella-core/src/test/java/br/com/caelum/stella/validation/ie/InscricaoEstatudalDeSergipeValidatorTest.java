...
import br.com.caelum.stella.validation.ie.InscricaoEstatudalDeSergipeValidator;
import br.com.caelum.stella.validation.Validator;
import br.com.caelum.stella.validation.InvalidStateException;

public class InscricaoEstatudalDeSergipeValidatorTest {

    private final String validString = "27123456-3";
    private final String wrongCheckDigitString = "27123456-4";
    
    private Validator<String> newValidator(){
        return new InscricaoEstatudalDeSergipeValidator();
    }
    ...
    public void shouldNotValidateIEWithInvalidCharacter() {
        ...
        Validator validator = new InscricaoEstatudalDeSergipeValidator(
