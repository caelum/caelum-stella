 ...
 * 
 */
public class IEMatoGrossoDoSulValidator extends BaseValidator<String> {
    ...
    public IEMatoGrossoDoSulValidator(MessageProducer messageProducer,
            boolean isFormatted) {
