 ...
 * href="http://www.sintegra.gov.br/Cad_Estados/cad_MS.html">SINTEGRA - ROTEIRO
 * DE CRÍTICA DA INSCRIÇÃO ESTADUAL </a>
 * 
 * @author Leonardo Bessa
 * 
 */
public class IEMatoGrossoDoSulValidator implements Validator<String> {
    ...
    public static final Pattern FORMATED = Pattern.compile("(28)[.](\\d{3})[.](\\d{3})[-](\\d{1})");

    public static final Pattern UNFORMATED = Pattern.compile("(28)(\\d{3})(\\d{3})(\\d{1})");
