 ...
 * 
 */
class IETocantinsAntigaValidator extends AbstractIEValidator {

    private static final int MOD = 11;

    private static final int DVX_POSITION = 3 + 11;

    private static final Integer[] DVX_MULTIPLIERS = IEConstraints.P6;
    ...
    public static final Pattern UNFORMATED = Pattern.compile("(29)((01)|(02)|(03)|(99))(\\d{3})(\\d{3})(\\d{1})");
	 ...
	 */
	public IETocantinsAntigaValidator() {
		super(true);
	}
